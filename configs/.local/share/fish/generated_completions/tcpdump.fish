...
complete -c tcpdump -s R --description 'Assume ESP/AH packets to be based on old specification (RFC1825 to RFC1829).'
...
complete -c tcpdump -l snapshot-length --description 'PD Snarf snaplen bytes of data from each packet rather than the default of 65…'
