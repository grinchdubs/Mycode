...
complete -c curl -s : -l next --description 'Tells curl to use a separate operation for the following URL and associated o…'
...
complete -c curl -l pinnedpubkey --description '(SSL) Tells curl to use the specified public key file to verify the peer.'
...
complete -c curl -l post301 --description '(HTTP) Tells curl to respect RFC 2616/10. 3.'
complete -c curl -l post302 --description '(HTTP) Tells curl to respect RFC 2616/10. 3.'
complete -c curl -l post303 --description '(HTTP) Tells curl to respect RFC 2616/10. 3.'
...
complete -c curl -l 'data-ascii.' --description 'the same but does not have a special interpretation of the @ character.'
