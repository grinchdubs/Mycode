...
complete -c git-diff-tree -l compaction-heuristic -l no-compaction-heuristic --description 'These are to help debugging and tuning an experimental heuristic (which is of…'
