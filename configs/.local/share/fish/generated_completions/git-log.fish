...
complete -c git-log -l 'pretty.' --description 'log. date config variable sets a default value for the log command\'s.'
...
complete -c git-log -l 'follow.' --description 'n is specified, it is a threshold on the similarity index (i. e.'
