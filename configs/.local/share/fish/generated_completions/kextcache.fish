...
complete -c kextcache -o mkext2 --description 'Create an mkext of format 2, used on Mac OS X version 10. 6 (Snow Leopard).'
complete -c kextcache -s e --description 'This option is provided for legacy compatibility, and is simply an alias to s…'
complete -c kextcache -s a --description 'Include in an mkext or prelinked kernel only kexts loadable on arch, thinning…'
